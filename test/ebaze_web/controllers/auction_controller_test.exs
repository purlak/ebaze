defmodule EbazeWeb.AuctionControllerTest do
  ...
  @create_attrs %{description: "some description", end_time: "2010-04-17T14:00:00Z", initial_price: "120.5", name: "some name", photo_url: "some photo_url", sold_status: true, start_time: "2010-04-17T14:00:00Z"}
